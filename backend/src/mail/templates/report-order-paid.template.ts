export function reportOrderPaidEmailHtml(params: { name: string; reportTitle: string; downloadUrl: string; year: number }) {
  const { name, reportTitle, downloadUrl, year } = params;
...
<html>
  <head>
    ...
    <title>Your report is ready to download</title>
  </head>
          ...
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="max-width:480px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #E3E5E8;">
            ...
            <tr>
              <td style="padding:36px 32px 8px;">
                <p style="margin:0 0 6px;font-family:'Courier New',monospace;font-size:11px;letter-spacing:1px;text-transform:uppercase;color:#4CB782;">Payment confirmed</p>
                <h1 style="margin:0 0 14px;font-size:21px;line-height:1.3;color:#14161A;">Thanks, ${name} — your report is ready</h1>
                <p style="margin:0 0 26px;font-size:14px;line-height:1.65;color:#4B5563;">
                  Payment for <b>${reportTitle}</b> has been confirmed. Click below to download your copy.
                </p>
              </td>
            </tr>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="border-radius:8px;background-color:#FF8A3D;">
                      <a href="${downloadUrl}" style="display:inline-block;padding:13px 30px;font-size:14px;font-weight:700;color:#1A0E04;text-decoration:none;">Download report</a>
                    </td>
                  </tr>
                </table>
              </td>
            ...
            <tr>
              <td style="padding:16px 32px 32px;">
                <p style="margin:0;font-size:12.5px;line-height:1.6;color:#9CA3AF;">
                  If the button doesn&rsquo;t work, copy this link: <a href="${downloadUrl}" style="color:#FF8A3D;">${downloadUrl}</a>
                </p>
              </td>
            </tr>
