...
export default function AdminProjectsPage() {
  ...
  const trialCount = projects.filter((p) => p.visibility === 'trial').length;
  ...
  return (
    <>
      <div className="gb-page-head">
        <div>
          ...
          <p className="gb-subtitle">
            View and manage every project in the system, regardless of owner. Projects tagged &quot;trial&quot; were
            auto-generated by a visitor from the home page&apos;s trial flow.
          </p>
        </div>
      </div>
      ...
      <div className="gb-stats">
        ...
        <div className="gb-stat-tile">
          <div className="gb-stat-num">{trialCount}</div>
          <div className="gb-stat-label">Auto-generated trials</div>
        </div>
        <div className="gb-stat-tile">
              ...
              <tbody>
                {projects.map((project) => (
                  <tr key={project._id}>
                    ...
                    <td>
                      <span className={`gb-badge ${project.visibility === 'trial' ? 'warn' : 'neutral'}`}>
                        {project.visibility === 'trial' ? 'Trial' : 'Private'}
                      </span>
                    </td>
